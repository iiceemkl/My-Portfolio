use AdventureWorks
/*  Student Name: Mangkhales Ngamjaruskotchakorn ID: 6188055*/
/*  Section: 1 Date: 2/23/2021 */
...
/*	Q3 Write a query that returns Name, LogInID and DepartmentName 
	...
	*/
-- Your Solution is here! 
SELECT p.FirstName + ' '+ p.LastName as Name, e.LoginID, d.Name as DepartmentName
FROM Person.Person p
